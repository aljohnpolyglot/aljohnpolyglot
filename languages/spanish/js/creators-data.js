...
const creatorsData = [
    ...
    },
    {
        ...
        cefr: ['B1', 'B2'],
        embeddedId: 'Kx0OOZ8ZaIY', // 20 CHICAS vs SÚPER GEOGRAFÍA
        aljohnsComment: "Hice mucha referencia a su estilo en uno de mis videos cuando hice super geografia",
    ...
    },
    {
        ...
        socialLinks: { instagram: 'https://www.instagram.com/lily_ladelfa/?hl=es' },
        tags: ['personalidades',]
    },
    {
        id: 'miriam-petricor',
        ...
        cefr: ['B1', 'B2'],
        embeddedId: 'Fc4vuGZ-i88', // Gameplay de Detroit: Become Human
        aljohnsComment: "Admito que es mi crush. La vi por casualidad en instagram y desde entonces me enganché. Ahora veo casi todos sus videos jajaja. Además canta muy bien.",
        socialLinks: { youtube: 'https://www.youtube.com/@Miriam_Petricor', instagram: 'https://www.instagram.com/miriam_petricor/' },
    ...
    },
    {
        ...
        cefr: ['B2', 'C1'],
        embeddedId: 'qVtFwPk-p1Y',
        aljohnsComment: "Empecé a ver el fútbol por ella. No tenía ni idea de fútbol, pero me enganché a su forma apasionada de contarlo.",
        socialLinks: { youtube: 'https://www.youtube.com/@alaskkag', instagram: 'https://www.instagram.com/alaskkag' },
    ...
    },
    {
        ...
        cefr: ['B1', 'C1'],
        embeddedId: 'aNS-GLjJx-g', // Clip de Anna hablando español
...

    {
        ...
        aljohnsComment: "muchos lo recomiendan, contenidos diseñados específicamente para estudiantes",
    ...
    },
    {
        ...
        aljohnsComment: "uno de los primeros canales que busco y contenido que veo cuando empiezo un idioma. menos mal que tambien hay subtitulos",
    ...
    },
    {
        ...
        aljohnsComment: "Ana es una leyenda. Mi primera profesora de español.",
    ...
    },
    {
        ...
        aljohnsComment: "Este canal es adictivo. Aprendes la historia detrás de las palabras que usas todos los días. Es fascinante y te da una apreciación mucho más profunda del idioma. También tiene un vídeo sobre filipinas. Uy Philippines!",
        socialLinks: { youtube: 'https://www.youtube.com/@Linguriosa', instagram: 'https://www.instagram.com/linguriosa/' },
        tags: [ 'ciencia y educación', 'personalidades']
    },
    {
        id: 'hola-spanish',
        name: 'Hola Spanish',
    ...
    },
    {
        ...
        aljohnsComment: "Este tío literalmente ya es latino con como habla español",
    ...
    // =======================================================
    {
        ...
        aljohnsComment: "Ver los vídeos de Luisito es como viajar con un amigo muy curioso. Espero que vaya a Filipinas",
    ...
    },
    {
        ...
        aljohnsComment: "El trabajo de Alex es increíblemente valiente e importante. Sus documentales son de una calidad cinematográfica y te abren los ojos a realidades que no verías en ningún otro sitio. Este tipo es mi modelo a seguir y quiero hacer contenido como él algún día ",
    ...
    },
    {
        ...
        aljohnsComment: "Mr. Beast de Latinoamerica! jajajajaj . Me río mucho con los videos de este tipo. Es jodidamente divertido, cuando quiero subir mi felicidad",
    ...
    },
    {
        ...
        aljohnsComment: "Este tío me cambió la vida, su vídeo sobre levantarse temprano es la razón por la que tengo el hábito desde entonces",
  ...
  
    {
        ...
        aljohnsComment: "Es muy interesante ver el contraste de culturas. Son una pareja muy simpática y su contenido es relajado y perfecto para una sesión de estudio ligera. Y tambien, yo quiero una chica como Lisanna jajaja",
...
},
{
    ...
    aljohnsComment: " 'una de las canciones que yo memoricé' fueron de Yatra. su canción «Cristina» es algo que le canté a una amiga mía en Argentina. Me pregunto dónde estará ahora. La canción evoca esta respuesta: 'y aunque yo esté en otra parte soy más feliz porque yo pude encontrarte y aunque no tenga la certeza de volverte a ver es tuya esta canción recuérdame'",   
...
},
{
    ...
    aljohnsComment: "La descubrí al azar, me alegro mucho. Le deseo lo mejor en su carrera.",
...
},
{
    ...
    aljohnsComment: "'muy muy underrated",
...
},
{
    ...
    aljohnsComment: "'besos en guerra' es un crack",
...
},
{
    ...
    aljohnsComment: "He seguido a TINI desde 'Violetta' pero solo acabo de terminar la temporada 1. Su evolución como artista es increíble. Yo estaba apoyando a ella con Yatra, yo estaba triste que se separaron. No sé por qué se operó las tetas, para mí ya era perfecta.",
...
},
{
    ...
    country: 'España',
    flagCode: 'es',
    shortDesc: 'Joven y talentosa cantante española, ganadora de "Tu Cara Me Suena".',
    longDesc: 'Melani es una cantante con una voz increíblemente potente y entrenada, capaz de cantar ópera. Representó a España en Eurovisión Junior y recientemente ganó el popular programa "Tu Cara Me Suena", demostrando su enorme versatilidad.',
    cefr: ['B1', 'B2'],
    embeddedId: 'Qo_Tod1GxyU',
...
},
{
    ...
    aljohnsComment: "usé sus canciones en uno de mis vídeos",
...
// ... (justo después del último objeto de la estantería anterior)
 // <-- No te olvides de la coma aquí

// =======================================================
// ==         TANDA 3 DE ARTISTAS MUSICALES             ==
// =======================================================
{
    id: 'luis-fonsi',
    name: 'Luis Fonsi',
    ...
    country: 'Puerto Rico',
    flagCode: 'pr',
    shortDesc: 'La legendaria voz de Puerto Rico, un maestro de la balada mucho más allá de "Despacito".',
    longDesc: 'Luis Fonsi es uno de los artistas latinos más exitosos de todos los tiempos. Antes del fenómeno mundial de "Despacito", ya tenía una carrera consolidada como uno de los mejores baladistas en español. Su increíble rango vocal y su versatilidad le permiten moverse del pop romántico al reguetón con total maestría.',
    cefr: ['A2', 'B1', 'B2'],
    embeddedId: 'wTwfHMXzTfg', // Échame La Culpa
    aljohnsComment: "Para mí, es un vocalista increíblemente infravalorado. Es tan versátil... Solo lo conocía por 'Despacito', pero es buenísimo. Pensaba que era un artista de reguetón como Bad Bunny, pero estaba muy equivocado. Su capacidad para cantar baladas es de otro nivel.",
    socialLinks: {
        youtube: 'https://www.youtube.com/@LuisFonsiVEVO',
...
},
{
    ...
    country: 'Argentina',
    flagCode: 'ar',
    shortDesc: 'La estrella del pop urbano y un ícono de la moda de Argentina.',
    longDesc: 'Emilia Mernes, conocida simplemente como Emilia, es una de las figuras clave en la nueva ola del pop argentino. Con un estilo que fusiona pop, reguetón y R&B, y una estética visual muy cuidada, se ha convertido en una de las artistas más influyentes de su generación.',
    cefr: ['B1', 'B2'],
    embeddedId: '_i322W0qS-A', // La_Original.mp3 con TINI
    aljohnsComment: "Es guapísima, un tesoro de Argentina, jaja. Su estilo y su música representan perfectamente la escena pop argentina actual.",
    socialLinks: {
        youtube: 'https://www.youtube.com/channel/UC4osEqmcQL5d1UYJVft-klA',
...
},
{
    ...
    country: 'España',
    flagCode: 'es',
    shortDesc: 'La "show-woman" definitiva de España: canta y baila a un nivel de élite.',
    longDesc: 'Mimi Doblas, conocida como Lola Indigo, es una verdadera "performer". Surgida de Fama a Bailar y Operación Triunfo, ha creado un proyecto musical donde el baile es tan importante como la voz. Sus shows en vivo son famosos por su increíble energía y coreografías complejas.',
    cefr: ['B2', 'C1'],
    embeddedId: '_5Wjnw85aHw', // Ya No Quiero Na
    aljohnsComment: "¡JODER, QUÉ CRACK ESTÁ TIA! Es una de las pocas artistas que realmente canta y baila al mismo tiempo a un nivel altísimo, justo el tipo de artista que estaba buscando. Técnicamente, es de las mejores. Sé que este estilo no es tan común en el mundo hispano, pero bailar mientras cantas es increíblemente difícil y ella es una maestra... ¡una mami!",
    socialLinks: {
        youtube: 'https://www.youtube.com/channel/UCX-dnA-fM_Udj_XyUY1XNnA',
...
// =======================================================
{
    ...
    aljohnsComment: "¡Mami! ¡Esta chica se merece más! Por favor quiero verla en España. Es rubia y canta muy bien y me gustan mucho sus canciones. Cuando escuche 'mil preguntas' tuve que comprobar lo que la música estaba jugando porque era super bueno.   ",
...
},
{
    ...
    aljohnsComment: "practico muchas de sus canciones porque son fáciles de cantar y muy emocionales.",
...
// },
{
    ...
    cefr: ['B1', 'B2'],
    embeddedId: 'kDI3v6kjnH8', // ELLA (envidia)
    ...
    socialLinks: { youtube: 'https://www.youtube.com/channel/UCDQRkgJS3uG3tALb_blEGfw_', instagram: 'https://www.instagram.com/jules.musica/?hl=es', spotify: 'https://open.spotify.com/intl-es/artist/1FCMSevL19uHKsMEPcTwfU' },
    tags: ['música']
},
{
    id: 'daniela-spalla',
...
},
{
    ...
    socialLinks: { youtube: 'https://www.youtube.com/channel/UCxCYCuDWNdSGnrCli5z1TWw', instagram: 'https://www.instagram.com/pablolopezmusic/', spotify: 'https://open.spotify.com/intl-es/artist/4uyqaioPEdClDxU6zvYlAZ' },
    tags: ['música']
},
...
},
{
    ...
    country: 'España',
    flagCode: 'es',
    shortDesc: 'El talk show más famoso de España, con entrevistas a las mayores estrellas del mundo.',
...
// =======================================================
{
    ...
    aljohnsComment: "Creo que su vídeo es el primer contenido que he visto íntegramente en español con subtítulos y que he tenido que pausar cada dos por tres. Es bueno ver mi progreso desde entonces",
...
},
{
    ...
    aljohnsComment: "en inglés, veo los videos de CanadianLad; en español, hago lo mismo en Caja Geek.",
...
},
{
    ...
    aljohnsComment: "A veces no tengo tiempo para ver una película, así que veo uno de sus resúmenes. Algunas tramas son literalmente demenciales y te harán pensar que el cine existe de verdad",
...

{
    ...
    aljohnsComment: "Netflix pero Espanol jajaja. En realidad veo aquí entrevista con los actores españoles que son exclusivos aquí",
...
// =======================================================
{
    ...
    aljohnsComment: "Si ves mis vídeos, me verás bucear por la cultura pop española, ahora ya sabes de dónde viene eses conocimientos",
...
},
{
    ...
    aljohnsComment: "Me gusta mucho cómo profundiza y comenta en las películas",
...
// =======================================================
{
    ...
    aljohnsComment: "He visto enchufetv por años y siempre me hacen reír. Su humor es muy rápido y lleno de localismos, y cada sketch está muy bien pensado.",
...
},
{
    ...
    aljohnsComment: "Esto es muy creativo y también educativo, sin pretender serlo. Me gustan mucho las partes animadas del cuerpo, jajaja.",
...
// =======================================================
{
    ...
    cefr: ['B1', 'C2'],
    embeddedId: 'Ky7FQq3aQm8', // Ejemplo de un análisis
    aljohnsComment: "Mi ritual de cada mañana. Drafteados es, para mí, el mejor canal de análisis de la NBA en español. El nivel de detalle es increíble y hablan con una pasión contagiosa. Indispensable. Los episodios duran unos 20 minutos y ya tengo mi dosis diaria de NBA.",
    socialLinks: { youtube: 'https://www.youtube.com/@DrafteadosNBA', instagram: 'https://www.instagram.com/drafteados' },
    tags: ['deportes']
},
{
    ...
    cefr: ['C1', 'C2'],
    embeddedId: 'SqkBLmoCRPs', // Ejemplo de un análisis táctico
    ...
    socialLinks: { youtube: 'https://www.youtube.com/@leocarranza99' },
    tags: ['deportes']
},
{
    id: 'nba-en-espanol',
    ...
    cefr: ['B1', 'B2'],
    embeddedId: 'q2npxN3LSqI', // Highlights de un partido
    ...
    socialLinks: { youtube: 'https://www.youtube.com/@somosnbaenespanol', },
    tags: ['deportes']
},
{
    id: 'maxi-yt-basket',
...
},
{
    ...
    cefr: ['B1', 'B2'],
    embeddedId: 'Qtl4WrPK_ek', // Vídeo sobre la línea de 4 puntos
...
},
{
    ...
    cefr: ['B1', 'B2'],
    embeddedId: 'MFb7LCqm6FE', // Highlights del último partido
...
},
{
    ...
    cefr: ['B2', 'C1'],
    embeddedId: 'yhOpmybYE7s', // Vídeo sobre un error común en el gimnasio
    ...
    socialLinks: { youtube: 'https://www.youtube.com/c/ATHLEANXEspa%C3%B1ol' },
...

{
    ...
    cefr: ['B1', 'B2'],
    embeddedId: '9H9N2yLZZLI', // Probando comida militar
    aljohnsComment: "Uno de los primeros youtubers que descubrí y seguí",
...

{
    ...
    cefr: ['B1', 'B2'],
    embeddedId: 'ukQ5FdOjExk', // Un Mundo Sin... Miedo
    aljohnsComment: "Descubrí esta joya y me volví adicto. Sus vídeos animados 'Un Mundo Sin...' son increíblemente creativos y te hacen pensar mucho. Me alegro de que se les reconozca ahora, ¡su esfuerzo en sus vídeos y creatividad son de clase mundial!",
...
},
{
    ...
    cefr: ['C1', 'C2'],
    embeddedId: 'NgHXFTgaVT0', // ¿Por qué el tema de Disney suena tan MÁGICO?
...
// =======================================================
{
    ...
    cefr: ['B2', 'C1'],
    embeddedId: 'ts0s80GFg-g', // Ejemplo sobre ayuno
    aljohnsComment: "Aprendo muchísimo con el Dr. La Rosa. Es genial para adquirir vocabulario técnico sobre salud y nutrición en español.",
    socialLinks: { youtube: 'https://www.youtube.com/@DRLAROSA' },
    tags: ['vlogs y viajes', 'ciencia y educación'] // Lo clasificamos aquí por "Estilo de Vida"
},
{
    ...
    cefr: ['C1', 'C2'],
    embeddedId: 'Iv7SgvuYEc4', // Análisis de Chess.com
    ...
    tags: ['ciencia y educación'] // Lo clasificamos aquí por "Estilo de Vida"
},
{
    id: 'visualpolitik',
    name: 'VisualPolitik',
    ...
    cefr: ['C1', 'C2'],
    embeddedId: 'ZoRHJBvFHEQ', // Ejemplo de vídeo
    aljohnsComment: "Este canal es increíble para entender lo que pasa en el mundo. El vocabulario es muy específico, así que es un gran desafío, pero sales de cada vídeo habiendo aprendido algo importante.",
...
},
{
    ...
    cefr: ['B1', 'B2'],
    embeddedId: 'AYQ8hT8cVTE', // La historia del Imperio Romano
...
},
{
    ...
    cefr: ['B2', 'C1'],
    embeddedId: 'mWuzzT-yJc8', // Ejemplo sobre agujeros negros
    aljohnsComment: "encuentro sus videos como Vsauce, por eso me gusta. Me gusta mucho su pasión por su oficio",
...
// =======================================================
{
    ...
    cefr: ['A1', 'A2', 'B1'],
    embeddedId: 'w3Qcau7f0KU', // Aprende Español con Moana
    aljohnsComment: "recuerdo cuando yo era un principiante que esperar a que este chicos uplaod todos los sábados, su contenido son perfectos para mí y me gustaría que él tiene más suscriptores, ya que eran muy útiles para mí.",
